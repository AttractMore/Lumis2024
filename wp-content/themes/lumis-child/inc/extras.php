...
if (!function_exists("astra_logo")) {
  ...
  function astra_logo($echo = true)
  {
    ...
    // echo '<a title="Lumis International" class="ast_site_identity_text_right_link" style="margin-left: auto;order: 1;"
    // href="'.get_page_link(238).'">
    // 		<span class="ast_site_identity_text_right">Lumis International</span></a>';
    /**
  ...
  if (!apply_filters("astra_disable_site_identity", false)) {
    ...
    $site_title_markup = apply_filters(
      ...
      sprintf(
        ...
        astra_attr("site-title", [
          "class" => "site-title",
        ]),
        astra_attr("site-title-link", [])
      )
    );
...
if (!function_exists("astra_get_custom_button")) {
  ...
  function astra_get_custom_button($button_text = "", $button_options = "", $button_style = "")
  {
    ...
    if ("1" == $outside_menu_item) {
      $custom_html =
        '<a class="ast-custom-button-link" href="' .
        esc_url(do_shortcode($header_button["url"])) .
        '" ' .
        $new_tab .
        " " .
        $link_rel .
...
if (!function_exists("astra_get_small_footer_custom_text")) {
  ...
  function astra_get_small_footer_custom_text($option = "")
  {
    ...
    if ("" != $option) {
      ...
      $theme_author = apply_filters("astra_theme_author", [
  ...
  function astra_header_markup()
  {
    do_action("astra_header_markup_before"); ?>
      ...
      "class" => join(" ", astra_get_header_classes()),
		...
		<?php do_action("astra_header_markup_after");
  }
}
...
if (!function_exists("astra_site_branding_markup")) {
  ...
  function astra_site_branding_markup()
  {
    ?>
			...
			<div class="site-branding left_aligned_top_bar ast-col-md-9">
				<div
			<?php echo astra_attr("site-identity", [
     ...
     "depth" => 2,
				...
				<!---->
				<!--				<ul class="topnav">-->
				<!--					<li class="border_active"><a class="" href="#home">Services</a></li>-->
				<!--					<li><a href="#news">Content Hub</a></li>-->
				<!--					<li><a href="#contact">News & Press</a></li>-->
...
if (!function_exists("astra_primary_navigation_markup")) {
  ...
  function astra_primary_navigation_markup()
  {
    ...
    if ($disable_primary_navigation) {
       ...
       * @var Array
       */
      $primary_menu_classes = apply_filters("astra_primary_menu_classes", ["main-header-menu", "ast-nav-menu", "ast-flex", "ast-justify-content-flex-end", $submenu_class]);
      ...
      $items_wrap = "<nav ";
      $items_wrap .= astra_attr("site-navigation", [
        "id" => "site-navigation",
      ...
      if (has_nav_menu("primary")) {
        ...
        //				echo '<div ' . astra_attr( 'ast-main-header-bar-alignment' ) . '>';
        echo '<div class="ast-col-xs-2 mobile_nav_button">';
        echo '<button style="padding-left: 0;padding-right: 0;" id="menu-toggle"></button>';
        ...
        echo '<div class="ast-main-header-bar-alignment right_aligned_top_bar ast-col-md-3">';
        // echo '<div class="right_column_header_text"><a title="Lumis Life Science Consulting" href="' . get_page_link(301) . '"><span>Lumis Life Science Consulting</span></a></div>';
        echo '<div class="main-header-bar-navigation">';
        echo "<nav ";
        echo astra_attr("site-navigation", [
          "id" => "site-navigation",
        ]);
...
{
  $classes = array_unique(apply_filters("astra_footer_class", ["site-footer"]));
  $classes = array_map("sanitize_html_class", $classes);
...
if (!function_exists("astra_comment_form_default_fields_markup")) {
  ...
  function astra_comment_form_default_fields_markup($fields)
  {
    ...
    $fields["author"] =
      '<div class="ast-comment-formwrap ast-row"><p class="comment-form-author ast-col-xs-12 ast-col-sm-12 ast-col-md-4 ast-col-lg-4">' .
      '<label for="author" class="screen-reader-text">' .
      esc_html(astra_default_strings("string-comment-label-name", false)) .
      '</label><input id="author" name="author" type="text" value="' .
      esc_attr($commenter["comment_author"]) .
      '" placeholder="' .
      esc_attr(astra_default_strings("string-comment-label-name", false)) .
      '" size="30"' .
      $aria_req .
      " /></p>";
    $fields["email"] =
      ...
      esc_html(astra_default_strings("string-comment-label-email", false)) .
      '</label><input id="email" name="email" type="text" value="' .
      esc_attr($commenter["comment_author_email"]) .
      '" placeholder="' .
      esc_attr(astra_default_strings("string-comment-label-email", false)) .
      '" size="30"' .
      $aria_req .
      " /></p>";
    $fields["url"] =
      '<p class="comment-form-url ast-col-xs-12 ast-col-sm-12 ast-col-md-4 ast-col-lg-4"><label for="url">' .
      '<label for="url" class="screen-reader-text">' .
      esc_html(astra_default_strings("string-comment-label-website", false)) .
      '</label><input id="url" name="url" type="text" value="' .
      esc_url($commenter["comment_author_url"]) .
      '" placeholder="' .
      esc_attr(astra_default_strings("string-comment-label-website", false)) .
      '" size="30" /></label></p></div>';
...
if (!function_exists("astra_comment_form_default_markup")) {
  ...
  function astra_comment_form_default_markup($args)
  {
    ...
    if ("post" == get_post_type() || $all_post_type_support) {
      ...
      $args["comment_field"] =
        '<div class="ast-row comment-textarea"><fieldset class="comment-form-comment"><div class="comment-form-textarea ast-col-lg-12"><label for="comment" class="screen-reader-text">' .
        esc_html(astra_default_strings("string-comment-label-message", false)) .
        '</label><textarea id="comment" name="comment" placeholder="' .
        esc_attr(astra_default_strings("string-comment-label-message", false)) .
        '" cols="45" rows="8" aria-required="true"></textarea></div></fieldset></div>';
    }
...
if (!function_exists("astra_entry_header_class")) {
  ...
  function astra_entry_header_class()
  {
    ...
    if (
      ...
      ("single-image" === astra_get_prop($blog_single_post_structure, 0) && empty($thumb_markup) && "single-title-meta" !== astra_get_prop($blog_single_post_structure, 1))
    ) {
    ...
    if (((!$check_is_singular && in_array("image", $blog_post_thumb)) || (is_single() && in_array("single-image", $single_post_thumb)) || is_page()) && has_post_thumbnail()) {
      if ($featured_image && (!$check_is_singular || (!post_password_required() && !is_attachment() && has_post_thumbnail()))) {
        $post_thumb = apply_filters(
          ...
          get_the_post_thumbnail(get_the_ID(), apply_filters("astra_post_thumbnail_default_size", "large"), apply_filters("astra_post_thumbnail_itemprop", ""))
        );
...
if (!function_exists("astra_color_palette")):
  ...
  {
    $color_palette = ["#000000", "#ffffff", "#dd3333", "#dd9933", "#eeee22", "#81d742", "#1e73be", "#8224e3"];
 ...
 */
function astra_attr($context, $attributes = [], $args = [])
{
