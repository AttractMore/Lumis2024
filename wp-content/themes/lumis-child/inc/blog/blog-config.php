...
if (!function_exists("astra_post_date")) {
  ...
  function astra_post_date()
  {
    ...
    $modified_on = sprintf(esc_html("%s"), $modified_date);
...
if (!function_exists("astra_post_author")) {
  ...
  function astra_post_author($output_filter = "")
  {
    ...
    echo "<span ";
    echo astra_attr("post-meta-author", [
    ...
    ?>
		  ...
		  <?php echo astra_attr("author-url", [
      "class" => "url fn n",
    ]); ?>
			>
				<span
				<?php echo astra_attr("author-name", [
      "class" => "author-name",
    ]); ?>
...
if (!function_exists("astra_post_link")) {
  ...
  function astra_post_link($output_filter = "")
  {
    ...
    $read_more_classes = apply_filters("astra_post_read_more_class", []);

    $post_link = sprintf(
      esc_html("%s"),
      '<a class="' .
        esc_attr(implode(" ", $read_more_classes)) .
        '" href="' .
    ...
    $output = ' &hellip;<p class="read-more primary-button"> ' . $post_link . "</p>";
...
if (!function_exists("astra_post_comments")) {
  ...
  function astra_post_comments($output_filter = "")
  {
     ...
     */
      ?>comments_popup_link(
      astra_default_strings("string-blog-meta-leave-a-comment", false),
      astra_default_strings("string-blog-meta-one-comment", false),
      astra_default_strings("string-blog-meta-multiple-comment", false)
    ); ?>
			</span>
...
if (!function_exists("astra_the_content_more_link")) {
  ...
  function astra_the_content_more_link($more_link_element = "", $more_link_text = "")
  {
    ...
    $read_more_classes = apply_filters("astra_the_content_more_link_class", []);
