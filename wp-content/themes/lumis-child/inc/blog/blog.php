...
if (!function_exists("astra_get_blog_post_thumbnail")) {
  ...
  function astra_get_blog_post_thumbnail($type = "archive")
  {
    if ("archive" === $type) {
      // Blog Post Featured Image.
      astra_get_post_thumbnail('<div class="ast-blog-featured-section post-thumb ast-col-md-3">', "</div>");
    } elseif ("single" === $type) {
      // Single Post Featured Image.
...
if (!function_exists("astra_get_blog_post_title_meta")) {
  ...
  function astra_get_blog_post_title_meta()
  {
    ...
    do_action("astra_archive_entry_header_before"); ?>
		<header class="entry-header ast-col-md-9 post_details">
			<?php
   ...
   astra_the_post_title(
     sprintf(
       '<a class="entry-title" href="%1$s" rel="bookmark">',
       esc_url(get_permalink()),
       astra_attr("article-title-blog", [
         "class" => "",
       ])
     ),
     "</a>",
   ...
   /* translators: 1: Current post link, 2: Current post id */
   astra_the_post_title_read_more(sprintf('<a class="primary-button read_more_archive" href="%1$s" rel="bookmark">', get_permalink()), "</a>", get_the_id());

   do_action("astra_archive_post_title_after");
   ?>
		</header><!-- .entry-header -->

		<?php do_action("astra_archive_entry_header_after");
  }
}
...
if (!function_exists("astra_get_single_post_title_meta")) {
  ...
  function astra_get_single_post_title_meta()
  {
    ...
    do_action("astra_single_post_order_before"); ?>
		<div class="ast-single-post-order" style="position: relative">
			<?php
   do_action("astra_single_post_title_before");

   astra_the_title(
     '<h1 class="entry-title" ' .
       astra_attr("article-title-blog-single", [
         "class" => "",
       ]) .
       ">",
     "</h1>"
   ...
   ?>
		...
		<?php do_action("astra_single_post_order_after");
  }
}
