  ...
  <article>
    <section class="about full-width">
      <div class="about-container wrap">
        ...
        if ($company) {
          echo '<section class="management-team">';
          ...
          if ($team_members->have_posts()) {
            while ($team_members->have_posts()) {
              ...
              if (in_array($company, $allocated_company) && get_field("management_team") === "yes") {
          ...
          if ($team_members->have_posts()) {
            ...
            while ($team_members->have_posts()) {
              ...
              if (in_array($company, $allocated_company) && get_field("management_team") === "no") {
                echo "<div class='team-member'>";
                display_team_member_details($linkedin_url, $email_address);
                echo "</div>";
              }
